...
NUM_CATCHUNKS_RUNNING=`ps auxwww | grep ndncatchunks | grep consumer3 | grep -v grep | wc -l`
...
mv $DIR/joined.png $DIR/consumer3.png
open $DIR/consumer3.png #this is the UBUNTU command for the image viewer change for your OS

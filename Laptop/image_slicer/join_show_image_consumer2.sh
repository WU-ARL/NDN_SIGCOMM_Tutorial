...
NUM_CATCHUNKS_RUNNING=`ps auxwww | grep ndncatchunks | grep consumer2 | grep -v grep | wc -l`
...
mv $DIR/joined.png $DIR/consumer2.png
open $DIR/consumer2.png #this is the UBUNTU command for the image viewer change for your OS
